...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'socios', ['Pais'])

        # Adding model 'Socios'
        db.create_table(u'socios_socios', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('pais', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['socios.Pais'])),
            ('position', self.gf('geoposition.fields.GeopositionField')(max_length=42, null=True, blank=True)),
            ('descripcion', self.gf('django.db.models.fields.TextField')()),
            ('contacto', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ...
        db.send_create_signal(u'socios', ['Socios'])


    def backwards(self, orm):
        # Deleting model 'Pais'
        db.delete_table(u'socios_pais')

        # Deleting model 'Socios'
        db.delete_table(u'socios_socios')
