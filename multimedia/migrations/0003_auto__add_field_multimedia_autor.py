...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Multimedia.autor'
        db.add_column(u'multimedia_multimedia', 'autor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Multimedia.autor'
        db.delete_column(u'multimedia_multimedia', 'autor_id')
    ...
    models = {
        ...
        u'multimedia.multimedia': {
            ...
            'autor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
