...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'publicaciones_publicaciones', (
            ...
            ('portada', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'publicaciones_publicaciones')
    ...
    models = {
        ...
        u'publicaciones.publicaciones': {
            'Meta': {'ordering': "('-id',)", 'object_name': 'Publicaciones'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'portada': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
