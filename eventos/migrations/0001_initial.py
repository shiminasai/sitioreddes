...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'eventos_categoria', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal(u'eventos', ['Categoria'])

        # Adding model 'Eventos'
        db.create_table(u'eventos_eventos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('categoria', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eventos.Categoria'], null=True, blank=True)),
            ('autor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'eventos', ['Eventos'])


    def backwards(self, orm):
        # Deleting model 'Categoria'
        db.delete_table(u'eventos_categoria')

        # Deleting model 'Eventos'
        db.delete_table(u'eventos_eventos')
    ...
    models = {
        ...
        u'eventos.eventos': {
            'Meta': {'ordering': "('-id',)", 'object_name': 'Eventos'},
            'autor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'categoria': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['eventos.Categoria']", 'null': 'True', 'blank': 'True'}),
